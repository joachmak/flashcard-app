			...
			<div style={styles.container}>
				<Card style={styles.card}>
					<div style={{ textAlign: "center", width: 500 }}>
						...
						<h5>
							To the flashcard-app that is (most likely not){" "}
							<span style={{ color: "#1890FF" }}>{word}</span>
							<span style={styles.line}>|</span> than other flashcard-apps
						</h5>
					</div>
					<Input
					...
					<Button loading={loading} style={styles.btn} type="primary" ghost>
						Register
					</Button>
				</Card>
			</div>
